...
const Song SOS = {song_of_storms};
const Song GFF = {great_fairy_fountain};
const Song test = {wholeNotesTest};
...
int main(void){ 
  ...
  Timer0A_Init(&Song_PlayHandler, F24HZ);		// initialize timer0A (16 Hz)
  EnableInterrupts();
