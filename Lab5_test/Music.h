...
#define Bus80MHz 80000000
#define Frequency_16HZ (Bus80MHz/16)
#define Frequency_20KHZ (Bus80MHz/20000)
#define Frequency_64HZ	(Bus80MHz/64)
...
//	 int duration;
// };
//typedef const struct notes STyp;
//STyp happy[25] = {{262,5}, {262,4}, {294,4}, {262,3},{349,2},{330,4},{262,5}, {262,5},{294,3},{262,4},{392,3},{349,3},{262,6},{262,4},{523,5},{440,2},{349,4},{330,3},{294,3},{466,4},{466,2},{440,1},{349,3},{392,3},{349,5}};
...
void musicPlay(uint32_t period);
